...
import Perceptron_Multi_Classe.ImageConverter;
public class Application_Images {
	...
	public static void main(String[] args) {
	  ...
	  /////////////////////////////////////////////////////////////////////////////////////
	     double[][]w =  Algorithme_Code.Preceptron_Multi (trainData , VecRefs ,0.01,10) ;    
   ...
   ////////////////////////////////////////////////////////////////////////////////////////  
	...
	for (int i = 0 ; i < testData.length;i++){
		...
		if(Classe != classePerceptron ){
			nberr++;
			System.out.println("la donnée  "+i+" est mal classé et elle represente le chiffre "+Classe + " et il est consideré par le perceptron comme un "+classePerceptron );
		}
	}
