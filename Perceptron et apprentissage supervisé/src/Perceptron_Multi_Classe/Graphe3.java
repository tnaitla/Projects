...
public class Graphe3 {
	// le nombre de Classe 
			...
			public static void main(String[] args) throws FileNotFoundException, IOException {
			  ...
			  /////////////////////////////////////////////////////////////////////////////////////
				int [] Graphetest = new int [100]; 
				 int [] Graphetrain = new int [100];
					for (int nbepoque = 1; nbepoque <= 100 ;nbepoque++ ){
				double[][]w =  Algorithme_Code.Preceptron_Multi (AvecbiaistrainIM, trainRefs ,0.007,nbepoque) ; 
			   ...
			   ////////////////////////////////////////////////////////////////////////////////////////  
				...
				System.out.println(nberrtest);    
				System.out.println(nberrtrain);	
				...
				PrintWriter writer = new PrintWriter("datatest3.txt", "UTF-8");
				PrintWriter writer1 = new PrintWriter("datatrain4.txt", "UTF-8");
				for(int k =0 ; k < 100 ; k++){
